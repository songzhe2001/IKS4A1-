...
{
  (void)IKS4A1_MOTION_SENSOR_Init(IKS4A1_LIS2DUXS12_0, MOTION_ACCELERO);
}
...
{
  (void)IKS4A1_MOTION_SENSOR_GetAxes(IKS4A1_LIS2DUXS12_0, MOTION_ACCELERO, Axes);
}
...
{
  (void)IKS4A1_MOTION_SENSOR_SetOutputDataRate(IKS4A1_LIS2DUXS12_0, MOTION_ACCELERO, Odr);
}
...
{
  (void)IKS4A1_MOTION_SENSOR_SetFullScale(IKS4A1_LIS2DUXS12_0, MOTION_ACCELERO, Fullscale);
}
